...
export default function Register() {
  ...
  return (
    <>
      <Head><title>Register – GotoDM</title></Head>
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 to-purple-100">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          ...
          <p className="text-gray-500 text-sm mb-6">Start automating Instagram DMs today</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Password <span className="text-gray-400 text-xs">(min 8 chars)</span></label>
              <input
                type="password"
                name="password"
                value={form.password}
